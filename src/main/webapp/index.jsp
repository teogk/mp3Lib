...
<html>
    ...
    <body background="<c:url value='/static/p.png' />">
        ...
        <p>Music is an art form and cultural activity whose medium is sound organized in time.
            ...
            de-emphasize or omit some of these elements. Music is performed with a vast range of instruments and vocal techniques ranging from singing to rapping; there are solely instrumental pieces,
